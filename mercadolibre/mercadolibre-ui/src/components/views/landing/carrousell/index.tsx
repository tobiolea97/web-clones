      ...
      <section className="andes-carousel-snapped__container andes-carousel-snapped__container--full andes-carousel-snapped__container--with-controls andes-carousel-snapped__container--strict-boundaries">
        <div className="andes-carousel-snapped__controls-wrapper">
          ...
          <div className="andes-carousel-snapped andes-carousel-snapped--scroll-hidden">
            <div
              className="andes-carousel-snapped__wrapper"
              // style="display: flex; will-change: transform; flex-direction: row; transition: transform 500ms; transform: translate3d(-9600px, 0px, 0px);"
            >
              <div
                role="group"
